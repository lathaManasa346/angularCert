...
@Component({
  selector: 'app-france-details',
  templateUrl: './france-details.component.html',
  styleUrls: ['./france-details.component.scss']
})
export class FranceDetailsComponent implements OnInit {
