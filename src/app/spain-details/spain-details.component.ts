...
@Component({
  selector: 'app-spain-details',
  templateUrl: './spain-details.component.html',
  styleUrls: ['./spain-details.component.scss']
})
export class SpainDetailsComponent implements OnInit {
